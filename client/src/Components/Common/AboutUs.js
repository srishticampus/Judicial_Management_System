  ...
  return (
    <div className="container">
        ...
        <div className="col-lg-6 col-md-6 col-sm-12">
          <div>
            <p className="text-justify" >
              ...
              Welcome to JudiSys, your trusted
            ...
            <h3>Our Mission</h3>
            <p className="text-justify" >
              At JudiSys, our mission is to empower individuals
      ...
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-12">
          <div>
            <h3>Why Choose Us?</h3>
            <p className="text-justify" >
              Choosing JudiSys means choosing a team of skilled
      ...
      <div className="mt-5">
        <h3>Our Team</h3>
        <p>
          Meet the faces behind JudiSys. Our team is comprised of
